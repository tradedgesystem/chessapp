  ...
  makeMove(move, record = false) {
    ...
    if (move.isCastle) {
      if (move.castleSide === 'K') {
        newBoard[this.coordToIndex(5,7)] = 'R';
        newBoard[this.coordToIndex(7,7)] = '';
      }
      if (move.castleSide === 'Q') {
        newBoard[this.coordToIndex(3,7)] = 'R';
        newBoard[this.coordToIndex(0,7)] = '';
      }
      if (move.castleSide === 'k') {
        newBoard[5] = 'r';
        newBoard[7] = '';
    ...
    newBoard[move.to] = move.promotion ? (this.whiteToMove ? move.promotion.toUpperCase() : move.promotion.toLowerCase()) : movingPiece;
