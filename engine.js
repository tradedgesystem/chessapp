class ChessEngine {
  ...
  generateKingMoves(index, moves, color) {
    ...
    if (color === 'w' && rank === 7 && file === 4) {
      if (this.castling.K && !this.board[5] && !this.board[6] && !this.isSquareAttacked(4,7,'b') && !this.isSquareAttacked(5,7,'b') && !this.isSquareAttacked(6,7,'b')) {
        moves.push(this.createCastleMove(index, 6, 'K'));
      }
      if (this.castling.Q && !this.board[3] && !this.board[2] && !this.board[1] && !this.isSquareAttacked(4,7,'b') && !this.isSquareAttacked(3,7,'b') && !this.isSquareAttacked(2,7,'b')) {
